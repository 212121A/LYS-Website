    ...
    <footer className="bg-foreground text-background mt-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          {/* Contact */}
          <div>
            <h3 className="font-semibold text-background/90 mb-4 tracking-wide uppercase text-xs">Kontakt</h3>
        ...
        <div className="border-t border-background/10 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-2 text-background/40 text-xs">
          <p>© {new Date().getFullYear()} Ly Asiatische Spezialitäten. Alle Rechte vorbehalten.</p>
