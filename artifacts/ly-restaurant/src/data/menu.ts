...
export const menuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "m-xoai", number: "03", name: "Matcha xoài (Mango)", nameKey: "matchaXoai", description: "Milch wählbar: Kuhmilch inkl. · Soja/Hafer/Kokos +0,50 · als Frappe +1 · als Proteinmatcha +2", price: 5, vegetarian: true, category: "matcha" },
      { id: "m-rasp", number: "04", name: "Matcha Raspberry (Himbeere)", nameKey: "matchaRaspberry", description: "Milch wählbar: Kuhmilch inkl. · Soja/Hafer/Kokos +0,50 · als Frappe +1 · als Proteinmatcha +2", price: 5, vegetarian: true, category: "matcha" },
      { id: "m-vietquat", number: "05", name: "Matcha việt quất (Blaubeere)", nameKey: "matchaVietQuat", description: "Milch wählbar: Kuhmilch inkl. · Soja/Hafer/Kokos +0,50 · als Frappe +1 · als Proteinmatcha +2", price: 5, vegetarian: true, category: "matcha" },
      { id: "m-dua-ananas", number: "06", name: "Matcha dứa (Ananas)", nameKey: "matchaDuaAnanas", description: "Milch wählbar: Kuhmilch inkl. · Soja/Hafer/Kokos +0,50 · als Frappe +1 · als Proteinmatcha +2", price: 5, vegetarian: true, category: "matcha" },
      { id: "m-vani", number: "07", name: "Matcha vani (Vanille)", nameKey: "matchaVani", description: "Milch wählbar: Kuhmilch inkl. · Soja/Hafer/Kokos +0,50 · als Frappe +1 · als Proteinmatcha +2", price: 5, vegetarian: true, category: "matcha" },
      { id: "m-dua-cloud", number: "08", name: "Matcha dừa (Coconut Cloud)", nameKey: "matchaDuaCloud", description: "Milch wählbar: Kuhmilch inkl. · Soja/Hafer/Kokos +0,50 · als Frappe +1 · als Proteinmatcha +2", price: 5.5, vegetarian: true, category: "matcha" },
    ],
  },
  {
    id: "ca-phe",
