...
export const menuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      { id: "c1", number: "c1", name: "Gemüse", nameKey: "itemGemuse", price: 7, vegetarian: true, spicy: true, veggieMix: true, category: "thaicurry" },
      { id: "c2", number: "c2", name: "Hähnchenfleisch mit Gemüse", nameKey: "itemHuhn", price: 9, spicy: true, halal: true, category: "thaicurry" },
      { id: "c3", number: "c3", name: "Paniertes Hähnchenfleisch mit Gemüse", nameKey: "itemHuhnPaniert", price: 10.5, spicy: true, halal: true, category: "thaicurry" },
      { id: "c4", number: "c4", name: "Fisch mit Gemüse", nameKey: "itemFisch", price: 10.5, spicy: true, category: "thaicurry" },
      { id: "c5", number: "c5", name: "Ente mit Gemüse", nameKey: "itemEnte", price: 11.5, spicy: true, halal: true, category: "thaicurry" },
  ...
  },
  {
    ...
    items: [
      { id: "s1", number: "s1", name: "Gemüse", nameKey: "itemGemuse", price: 7, vegetarian: true, veggieMix: true, category: "suesssauer" },
      { id: "s2", number: "s2", name: "Hähnchenfleisch mit Gemüse & Ananas", nameKey: "itemHuhnAnanas", price: 9, halal: true, category: "suesssauer" },
      { id: "s3", number: "s3", name: "Paniertes Hähnchenfleisch mit Gemüse & Ananas", nameKey: "itemHuhnPaniertAnanas", price: 10.5, halal: true, category: "suesssauer" },
      { id: "s4", number: "s4", name: "Fisch mit Gemüse", nameKey: "itemFisch", price: 10.5, category: "suesssauer" },
      { id: "s5", number: "s5", name: "Ente mit Gemüse & Ananas", nameKey: "itemEnteAnanas", price: 11.5, halal: true, category: "suesssauer" },
  ...
  },
  {
    ...
    subtitleKey: "subtitleRiceNoodles",
    items: [
      { id: "b1", number: "b1", name: "Gemüse", nameKey: "itemGemuse", price: 7, vegetarian: true, veggieMix: true, category: "soja" },
      { id: "b2", number: "b2", name: "Hähnchenfleisch mit Gemüse", nameKey: "itemHuhn", price: 9, halal: true, category: "soja" },
      { id: "b3", number: "b3", name: "Paniertes Hähnchenfleisch mit Gemüse", nameKey: "itemHuhnPaniert", price: 10.5, halal: true, category: "soja" },
      { id: "b4", number: "b4", name: "Fisch mit Gemüse", nameKey: "itemFisch", price: 10.5, category: "soja" },
      { id: "b5", number: "b5", name: "Ente mit Gemüse", nameKey: "itemEnte", price: 11.5, halal: true, category: "soja" },
  ...
  },
  {
    ...
    items: [
      { id: "e1", number: "e1", name: "Gemüse", nameKey: "itemGemuse", price: 7, vegetarian: true, spicy: true, veggieMix: true, category: "erdnuss" },
      { id: "e2", number: "e2", name: "Hähnchenfleisch mit Gemüse", nameKey: "itemHuhn", price: 9, spicy: true, halal: true, category: "erdnuss" },
      { id: "e3", number: "e3", name: "Paniertes Hähnchenfleisch mit Gemüse", nameKey: "itemHuhnPaniert", price: 10.5, spicy: true, halal: true, category: "erdnuss" },
      { id: "e4", number: "e4", name: "Fisch mit Gemüse", nameKey: "itemFisch", price: 10.5, spicy: true, category: "erdnuss" },
      { id: "e5", number: "e5", name: "Ente mit Gemüse", nameKey: "itemEnte", price: 11.5, spicy: true, halal: true, category: "erdnuss" },
  ...
  },
  {
    ...
    subtitleKey: "subtitleRiceNoodles",
    items: [
      { id: "m8", number: "m8", name: "Gemüse", nameKey: "itemGemuse", price: 7, vegetarian: true, veggieMix: true, category: "mango-sosse" },
      { id: "m9", number: "m9", name: "Hähnchenfleisch mit Gemüse", nameKey: "itemHuhn", price: 9, halal: true, category: "mango-sosse" },
      { id: "m10", number: "m10", name: "Paniertes Hähnchenfleisch mit Gemüse", nameKey: "itemHuhnPaniert", price: 10.5, halal: true, category: "mango-sosse" },
      { id: "m11", number: "m11", name: "Fisch mit Gemüse", nameKey: "itemFisch", price: 10.5, category: "mango-sosse" },
      { id: "m12", number: "m12", name: "Ente mit Gemüse", nameKey: "itemEnte", price: 11.5, halal: true, category: "mango-sosse" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "a2", number: "a2", name: "Hähnchenfleisch mit Gemüse", nameKey: "itemHuhn", price: 8.5, halal: true, category: "gebratener-reis" },
      { id: "a3", number: "a3", name: "Paniertes Hähnchenfleisch mit Gemüse", nameKey: "itemHuhnPaniert", price: 10.5, halal: true, category: "gebratener-reis" },
      { id: "a4", number: "a4", name: "Fisch mit Gemüse", nameKey: "itemFisch", price: 10.5, category: "gebratener-reis" },
      { id: "a5", number: "a5", name: "Ente mit Gemüse", nameKey: "itemEnte", price: 11.5, halal: true, category: "gebratener-reis" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "box-huehnchen", name: "Hähnchen", nameKey: "boxHuehnchen", price: 6, priceSmall: 4.5, halal: true, category: "nudel-reisboxen" },
      { id: "box-pan-huehnchen", name: "Paniertes Hähnchen", nameKey: "boxHuhnPaniert", price: 6, halal: true, category: "nudel-reisboxen" },
  ...
  },
  {
    ...
    nameKey: "catMatcha",
    items: [
      { id: "m-latte", number: "01", name: "Matcha Latte (warm/kalt)", nameKey: "matchaLatte", description: "Milch wählbar: Kuhmilch inkl. · Soja/Hafer/Kokos +0,50 · als Proteinmatcha +2", price: 4.5, vegetarian: true, category: "matcha" },
      { id: "m-dau", number: "02", name: "Matcha dâu (Erdbeere)", nameKey: "matchaDau", description: "Milch wählbar: Kuhmilch inkl. · Soja/Hafer/Kokos +0,50 · als Proteinmatcha +2", price: 5, vegetarian: true, category: "matcha" },
      { id: "m-xoai", number: "03", name: "Matcha xoài (Mango)", nameKey: "matchaXoai", description: "Milch wählbar: Kuhmilch inkl. · Soja/Hafer/Kokos +0,50 · als Proteinmatcha +2", price: 5, vegetarian: true, category: "matcha" },
      { id: "m-rasp", number: "04", name: "Matcha Raspberry (Himbeere)", nameKey: "matchaRaspberry", description: "Milch wählbar: Kuhmilch inkl. · Soja/Hafer/Kokos +0,50 · als Proteinmatcha +2", price: 5, vegetarian: true, category: "matcha" },
      { id: "m-vietquat", number: "05", name: "Matcha việt quất (Blaubeere)", nameKey: "matchaVietQuat", description: "Milch wählbar: Kuhmilch inkl. · Soja/Hafer/Kokos +0,50 · als Proteinmatcha +2", price: 5, vegetarian: true, category: "matcha" },
      { id: "m-dua-ananas", number: "06", name: "Matcha dứa (Ananas)", nameKey: "matchaDuaAnanas", description: "Milch wählbar: Kuhmilch inkl. · Soja/Hafer/Kokos +0,50 · als Proteinmatcha +2", price: 5, vegetarian: true, category: "matcha" },
      { id: "m-vani", number: "07", name: "Matcha vani (Vanille)", nameKey: "matchaVani", description: "Milch wählbar: Kuhmilch inkl. · Soja/Hafer/Kokos +0,50 · als Proteinmatcha +2", price: 5, vegetarian: true, category: "matcha" },
      { id: "m-dua-cloud", number: "08", name: "Matcha dừa (Coconut Cloud)", nameKey: "matchaDuaCloud", description: "Milch wählbar: Kuhmilch inkl. · Soja/Hafer/Kokos +0,50 · als Proteinmatcha +2", price: 5.5, vegetarian: true, category: "matcha" },
    ],
  },
  {
    id: "ca-phe",
    ...
    items: [
      ...
      { id: "cp-nau-da", number: "12", name: "Cà phê nâu đá", nameKey: "caPheNauDa", description: "Milch wählbar: Kuhmilch · Sojamilch · Hafermilch · Kokosmilch (ohne Aufpreis)", price: 5, category: "ca-phe" },
